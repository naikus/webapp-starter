 ...
 * @property {function(string|namespace, EventListener | NsEventListener)} on - Subscribe to an event
 * or a namespace
 * @property {function(string, EventListener)} on - Subscribe to an event or a namespace
 * @property {function(string|namespace, EventListener | NsEventListener)} once - Subscribe
 * to an event or a namespace once
